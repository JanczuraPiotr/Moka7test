 ...
 */
package snap7.lib.moka7demo;

/**
 *
 * @author Dave Nardella
 */
import snap7.lib.moka7.S7CpInfo;
import snap7.lib.moka7.S7;
import snap7.lib.moka7.S7OrderCode;
import snap7.lib.moka7.S7Szl;
import snap7.lib.moka7.IntByRef;
import snap7.lib.moka7.S7Client;
import snap7.lib.moka7.S7BlockInfo;
import snap7.lib.moka7.S7CpuInfo;
import snap7.lib.moka7.S7Protection;
...
public class ClientDemo {
    ...
    private static String IpAddress = "192.168.16.222";
    private static int Rack = 0; // Default 0 for S7300
    private static int Slot = 2; // Default 2 for S7300 
    private static int DBSample = 100; // Sample DB that must be present in the CPU
